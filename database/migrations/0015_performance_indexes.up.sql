...
CREATE INDEX idx_matricula_academia_aluno_status ON matricula (academia_id, aluno_id, status);
...
CREATE INDEX idx_pagamento_academia_pedido_status ON pagamento (academia_id, pedido_id, status);
