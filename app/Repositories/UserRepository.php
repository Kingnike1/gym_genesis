...
class UserRepository extends BaseRepository
{
    ...
    {
        $sql = "SELECT u.idusuario, u.email, u.senha, u.status, u.session_version,
    ...
    {
        $this->db->prepare('UPDATE usuario SET last_login_at = CURRENT_TIMESTAMP WHERE idusuario = ?')->execute([$id]);
    }
